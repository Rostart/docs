...
=======
- **Progettazione**: Processo di sviluppo di un piano per la creazione di qualcosa.
>>>>>>> a231e2b (docs(keywords): add new keywords)
...
=======
- **Ruby**:Un linguaggio di programmazione orientato agli oggetti simile a Python.
>>>>>>> a231e2b (docs(keywords): add new keywords)
...
=======
- **A Grafo**: Database che memorizza i daticome nodi e archi.I nodi rappresentano entità.
>>>>>>> a231e2b (docs(keywords): add new keywords)
...
=======
- **Branch**:Un puntatore mobile leggerissimo a uno snapshot della cronologia del repository.
>>>>>>> a231e2b (docs(keywords): add new keywords)
...
=======
  **Fix**: Correggere o risolvere un bug nel codice durante il processo di debugging.
- **Portata**: Il testing viene eseguito sull'intero sistema software, mentre il debugging viene eseguito su un modulo o componente specifico.
>>>>>>> a231e2b (docs(keywords): add new keywords)
...
=======
- **Coerenza**:Dovrebbe essere coerente nel suo design, implementazione e utilizzo.
>>>>>>> a231e2b (docs(keywords): add new keywords)
...
=======
- **Malware**: Un software progettato per danneggiare un sistema informatico. Il malware può includere virus, trojan, worm, ransomware e spyware.
>>>>>>> a231e2b (docs(keywords): add new keywords)
...
=======
- **Scalabilità**: Garantire che il sistema possa gestire un aumento del carico di lavoro senza perdere prestazioni.
>>>>>>> a231e2b (docs(keywords): add new keywords)
...
=======
- **Public cloud**:Il cloud pubblico è un modello in cui i servizi cloud sono disponibili al pubblico, come Amazon Web Services (AWS), Microsoft Azure e Google Cloud Platform (GCP).
>>>>>>> a231e2b (docs(keywords): add new keywords)
...
=======
- **Testing and development**: Le aziende possono utilizzare le macchine virtuali per testare e sviluppare nuovi software
>>>>>>> a231e2b (docs(keywords): add new keywords)
